...
class clsSYSTEMTIME
	...
	public:
		...
		double							dValue() const
											{
											double	dThis;
											::SystemTimeToVariantTime(const_cast<SYSTEMTIME*>(static_cast<const SYSTEMTIME*>(this)),&dThis);
											return(dThis);
											}
		static int						__SecondsSince19700101(int nYear, int nMonth, int nDay, int nHour, int nMinute, int nSecond)
											{
