...
typedef WCValSkipListDictIter<String,clsDataItem> 				clsDataItemListIter;
...
typedef WCValSkipListDictIter<clsSYSTEMTIME,clsDataItemList> 	clsDataListIter;
class clsDataList
	...
	public:
		...
		void							Add(const clsSYSTEMTIME& ST, const clsDataItemList& DL)
											{
											insert(ST,DL);
											}
		void							Dump()
...
typedef WCValSkipListDictIter<clsLocalNetID,clsDataList*> 	clsDeviceDataListIter;
class clsDeviceDataList
	...
	public:
		...
		void							Add(const clsLocalNetID& ID, const clsSYSTEMTIME& ST, const clsDataItemList& DL)
											{
											clsDataList*	pDL;
