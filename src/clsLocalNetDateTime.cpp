...
bool                            clsLocalNet::QueryLoggerDateTime(
    clsSYSTEMTIME& ST)
{
    bool            bRes(false);
...
bool                            clsLocalNet::SetLoggerDateTime(
    const clsSYSTEMTIME& ST)
{
    bool            bRes(false);
    clsResult<bool> APILog("clsLocalNet::QueryLoggerDateTime",bRes);
    clsIGMessage    MsgQuery(   IGID_PC,
    ...
    MsgQuery.SetPayload(6,ST.wSecond,ST.wMinute,ST.wHour,ST.wDay,ST.wMonth,
                        ST.wYear-2000);
